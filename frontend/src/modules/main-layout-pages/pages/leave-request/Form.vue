          ...
          <b-row>
            <b-col lg="12" md="12" sm="12" xs="12">
              <ValidationProvider name="Start Date" vid="start_date" v-slot="{ errors }">
                <b-form-group id="start_date" label="start_date" label-for="start_date">
                  <template v-slot:label>
                    Start Date
                  </template>
                  <b-form-input type="date" id="start_date" v-model="form.start_date" placeholder="Enter start date"
            ...
            <b-col lg="12" md="12" sm="12" xs="12">
              <ValidationProvider name="End Date" vid="end_date" v-slot="{ errors }">
                <b-form-group id="end_date" label="end_date" label-for="end_date">
                  <template v-slot:label>
                    End Date
                  </template>
                  <b-form-input type="date" id="end_date" v-model="form.end_date" placeholder="Enter end date"
                    :state="errors[0] ? false : (valid ? true : null)"></b-form-input>
                  <div class="invalid-feedback">
                    {{ errors[0] }}
                  </div>
            ...
            <b-col lg="12" md="12" sm="12" xs="12">
              <ValidationProvider name="Reason" vid="reason" v-slot="{ errors }">
                <b-form-group id="reason" label="reason" label-for="reason">
                  ...
                  <b-form-input id="reason" v-model="form.reason" placeholder="Enter leave reason"
                    :state="errors[0] ? false : (valid ? true : null)"></b-form-input>
                  <div class="invalid-feedback">
                    {{ errors[0] }}
                  </div>
